...
const routes = {
    ...
    "/web/Lab9/": "/web/Lab9/index.html",
    "/web/Lab9/catalog": "/web/Lab9/pages/catalog.html",
    "/web/Lab9/catalog/1": "/web/Lab9/pages/catalog_data.html",
    "/web/Lab9/catalog/2": "/web/Lab9/pages/catalog_data.html",
    "/web/Lab9/catalog/3": "/web/Lab9/pages/catalog_data.html",
    "/web/Lab9/catalog/4": "/web/Lab9/pages/catalog_data.html",
    "/web/Lab9/catalog/5": "/web/Lab9/pages/catalog_data.html",
    "/web/Lab9/catalog/6": "/web/Lab9/pages/catalog_data.html",
};
...
const handleLocation = async () => {
    ...
    if (path === "/web/Lab9/") {
        ...
        if (data) {
            ...
            for (const item of data.data) {
                dataText += `<div class="flex flex-col">
                <a href="/web/Lab9/catalog/${item.id}" onclick="route()" class="relative inline-flex overflow-hidden p-4 w-full h-full m-auto mb-2">
                  <div class="w-full h-full absolute left-0 top-0 z-10 border-white border-2"></div>
                  <img src="${item.image}" class="w-full h-full z-0 opacity-90 object-cover" alt="">
                  <div class="absolute left-0 bottom-0 z-30 p-7 h-48 overflow-hidden w-full">
                ...
                <a href="/web/Lab9/catalog/${item.id}" class="inline-block px-6 py-3 font-semibold bg-gradient-to-r from-purple-500 to-indigo-500 rounded-full shadow-md hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-500 hover:shadow-lg transition duration-300 ease-in-out" onclick="route()">Go to</a>
              </div>`
            }
            dataText += `<a class="inline-flex col-span-3 justify-center items-center p-2 w-full font-bold bg-red-500 rounded-lg shadow-md hover:bg-red-600 transition duration-300 ease-in-out" href="/web/Lab9/catalog/${getRandomInt(data.data.length)}" onclick="route()">Random Catalog</a>
            `;
            document.getElementById("app").innerHTML = html;
            document.getElementById('catalog-section').innerHTML = dataText
            return;
